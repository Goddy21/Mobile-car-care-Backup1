...
public class MechLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.no_account);
            ...
            public void onClick(View v) {
                ...
                if(username.length()==0){
                    ...
                    if(db.login(username,password)==1){
                        ...
                        editor.apply();
                        startActivity(new Intent(MechLoginActivity.this, MechanicsDashboardActivity.class));
                    }else{
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MechLoginActivity.this,MechSignUpActivity.class));
            }
        });
    }
}